...
public class SemanticTable {
   ...
   static int expTable [][][] = 
     ...
     /*  CHAR*/ {{ERR,ERR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR},{STR,ERR,ERR,ERR,ERR},{STR,ERR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR}}, 
     /*STRING*/ {{ERR,ERR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR},{STR,ERR,ERR,ERR,ERR},{STR,ERR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR}},
     /*  BOOL*/ {{ERR,ERR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR},{ERR,ERR,ERR,ERR,ERR},{ERR,ERR,BOO,ERR,ERR}}                        
                };
